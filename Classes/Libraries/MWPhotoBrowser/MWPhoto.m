...
- (void)loadImageFromFileAsync {
    ...
    @try {
        ...
        SEL didFinishSelector = (shouldDecode) ? @selector(imageDidFinishLoadingSoDecompress) : @selector(imageLoadingComplete);
        [self performSelectorOnMainThread:didFinishSelector withObject:nil waitUntilDone:NO];
        [pool drain];
    }
}
